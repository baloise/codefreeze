...
public class IsCodeFreezeHookEnabledCondition implements Condition {

    final RepositoryHookService repositoryHookService;

    public IsCodeFreezeHookEnabledCondition(@ComponentImport RepositoryHookService repositoryHookService){
    ...
    public boolean shouldDisplay(Map<String, Object> params) {
        ...
        if(repo != null) {
            ...
            RepositoryHook mergeHook = repositoryHookService.getByKey(scope, "com.baloise.open.bitbucket.codefreeze:isAdminCodefreezeMergeCheck");
